...
public class GameSettings : MonoBehaviour
{
    ...
    public int noOfTargets = 3;
    public double score = 0;
    public float missedShots, targetsHit = 0;
    public float accuracy = 100;
    public bool isMoving, isDecreasing;
    public float thickness, centerThickness, centerCrosshairValue, verticalCrosshairValue, horizontalCrosshairValue, gap, mouseSensitivity;
